      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center gap-6">
            <a href="https://www.linkedin.com/in/hannah-aurora-busto-1a16502aa/" className="text-gray-400 hover:text-primary-400 transition-colors transform hover:scale-110">
